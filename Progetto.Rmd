...
InformationValue::confusionMatrix(test.balanced$y, yhat.glm)
```
...
InformationValue::plotROC(test.balanced$y, yhat.bss)
```
...
fit.rf.control = trainControl(method="repeatedcv", number=10, repeats=10)
fit.rf = train(y ~ ., data=train.balanced, method="ordinalRF", trControl=fit.rf.control)
