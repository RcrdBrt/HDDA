...
p3 <- MyConfusionMatrix(test$y, yhat.glm, title="Logit Weighted")
p1+p2+p3
```
...
yhat.glm.backward = predict(fit.glm.backward, test)

MyConfusionMatrix(test$y, yhat.glm.backward, title = "Logistic Regression - Backward Elimination")

cat("Accuracy = ", 1-InformationValue::misClassError(test$y, yhat.glm.backward))
```
