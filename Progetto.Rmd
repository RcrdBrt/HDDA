...
title(main="Time-dependent ROC at end of lending")
```
...
```{r}
score <- Score(list("LogReg"=fit.glm.under,
                    "LogReg PCA"=fit.pca,
...
score <- Score(list("Cox"=fit.cox.strata),
              formula=y~1,
              data=test, conf.int=F,
              plots=c("calibration","ROC"),
              progress.bar=1)
